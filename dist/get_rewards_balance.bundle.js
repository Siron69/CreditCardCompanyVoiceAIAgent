...
var get_rewards_balance_default = import_schema.w.tool({
...
// dist/__get_rewards_balance_wrapper.ts
async function main(ctx, params) {
  const toolParams = ctx?.data ?? params ?? {};
  return await get_rewards_balance_default.handler(ctx, toolParams);
}
