...
var get_rewards_catalog_default = import_schema.w.tool({
...
// dist/__get_rewards_catalog_wrapper.ts
async function main(ctx, params) {
  const toolParams = ctx?.data ?? params ?? {};
  return await get_rewards_catalog_default.handler(ctx, toolParams);
}
